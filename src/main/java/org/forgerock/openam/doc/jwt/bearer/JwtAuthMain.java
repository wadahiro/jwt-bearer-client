 ...
 */
public final class JwtAuthMain {
    ...
    private static PrivateKey getPrivateKey() {
        ...
        try {
            ...
            keystore.load(JwtAuthMain.class.getResourceAsStream("/keystore.jks"),
    ...
    private static void post(String idToken) throws Exception {
        ...
        grantType = URLEncoder.encode(
                "authorization_code", "UTF-8");
        String data = "" 
                + "client_assertion_type=" + clientAssertionType
                + "&client_assertion=" + idToken
                + "&grant_type=" + grantType
                + "&assertion=" + idToken
                + "&code=4e0d144f-bb30-4d41-b721-f639ccca03e8&redirect_uri=http://localhost";

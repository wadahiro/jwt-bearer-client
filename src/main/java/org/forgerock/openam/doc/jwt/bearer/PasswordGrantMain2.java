 ...
 */
public final class PasswordGrantMain2 {
    ...
    private static PrivateKey getPrivateKey() {
        ...
        try {
            ...
            keystore.load(PasswordGrantMain2.class.getResourceAsStream("/keystore.jks"),
    ...
    private static void post(String idToken) throws Exception {
        ...
        String data = "grant_type=" + "password"
                ...
                + "&password=" + "password"
                + "&client_id=" + clientId
                + "&code=3898155d-132a-4ab7-b60b-cc9a5b61ea69&redirect_uri=http://localhost";

 ...
 */
public final class PasswordGrantMain {
    ...
    private static PrivateKey getPrivateKey() {
        ...
        try {
            ...
            keystore.load(PasswordGrantMain.class.getResourceAsStream("/keystore.jks"),
    ...
    private static void post(String idToken) throws Exception {
        ...
        String data = "grant_type=" + "password"
                ...
                + "&client_id=" + clientId
                + "&assertion=" + idToken;
//                + "&code=430fd06e-f54b-4e36-b5c9-06e8c635f08d&redirect_uri=http://localhost";
